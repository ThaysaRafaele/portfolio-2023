...
const introduction = {
  text: [
    "Olá, Fico feliz que tenha me encontrado! :)",

    "Me chamo Thaysa, tenho 25 anos, sou mãe e estou finalizando a gradução em tecnologia da informação pela UFMS. Tenho uma enorme paixão por tecnologia, em especial por desenvolvimento frontend.",

    "Como Hobby, gosto ler e crochetar. Também estou tentando criar um jardim em casa e amo jogos de tabuleiro.",

    "Gosto de trabalhar com pessoas e equipes, e acredito que pessoas trabalhando em conjunto para entregar valor é mais importante do que processos ou frameworks (por mais que possam ajudar bastante).",
     
    "Sua visita ao meu portfólio é profundamente apreciada!",
  ],
};
