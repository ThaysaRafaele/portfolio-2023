...
const fadeIn = (direction: "left" | "right" | "up" | "down", type: string, delay: number, duration: number) => {
    return {
      hidden: {
  ...
  function HOC() {
    return (
      <motion.section
        ...
        className={`sm:px-16 px-6 sm:py-16 py-10 max-w-7xl mx-auto relative z-0 my-[-17%] w-[500%]`}
        style={{ marginLeft: "-20%" }}
      >
